...
namespace SourceGit.Converters
{
    public static class DoubleConverters
    {
        ...
        public static readonly FuncValueConverter<double, double> DecreaseBy2 =
            new FuncValueConverter<double, double>(v => v - 2.0);
        ...
        public static readonly FuncValueConverter<double, double> ToRowHeight =
            new FuncValueConverter<double, double>(v => v * 2.0 + 4.0);
